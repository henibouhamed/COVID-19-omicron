...
dataset = read_csv('D:\\data 19012022bis.txt', sep='\t', decimal=',',header=None, index_col=None)
...
for j in range(10): 
  ...
  # fit network
  history = model.fit(x_train, y_train, epochs=1000, batch_size=783, validation_data=(x_test, y_test), verbose=2, shuffle=False)
